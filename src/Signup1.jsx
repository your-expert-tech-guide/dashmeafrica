    ...
    <div>
      ...
      <nav className="flex items-center justify-between p-4  text-black">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className="inline-block font-lg rounded-lg border mr-6 border-solid border-[#568203] p-2  w-15 text-xs font-medium leading-normal text-black transition duration-150 ease-in-out hover:border-black-100 hover:bg-black-200  focus:border-#568203 focus:text-neutral-100 focus:outline-none focus:ring-0 active:border-black-200 active:text-dark:hover:bg-neutral-100 dark"
          >
      ...
      <div className="flex">
        <div className="w-3/5 p-8">
          {/* Register with Email */}
          <h2 className="text-2xl font-semibold text-black-600 mb-4 text-center">Register</h2>
          <p className="text-sm text-gray-700 mb-6 text-center ">Join to donate or sell to anyone in Nigeria with FREE DELIVERY</p>
          <button
          ...
          <div className="my-4 mt-12 mb-12 flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-neutral-300 after:mt-0.5 after:flex-1 after:border-t after:border-neutral-300">
              ...
              <button
                className="w-full max-w-full shadow-sm rounded-lg p-2 border-2 border-black-600 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline hover:shadow focus:shadow-sm focus:shadow-outline mt-5"
              >
      ...
      <div className="text-center w-full p-4">
        <p className="text-gray-600">
          Already have an account? <a href="#" className="text-[#568203]"><Link to="/Login">Login</Link></a>
        </p>
      </div>
        </div>
