...
const Hero = () => {
  return (
    <div className="pt-7">
      <div className="hero1 bg-no-repeat w-full h-[504px] max-[426px]:bg-hero-pattern-m max-[686px]:bg-hero-pattern-md max-[540px]:bg-hero-pattern-5 max-[951px]:bg-hero-pattern-9 2xl:bg-repeat-x">
