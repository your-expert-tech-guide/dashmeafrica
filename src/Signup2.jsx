  ...
  return (
    <div>
      ...
      <div className="flex">
        <div className="w-1/2 p-10">
          ...
          <form className="mt-6">
            <div className="mb-2">
              <input
                type="text"
                className="block w-full px-4 py-2 peer  text-black  bg-white border rounded-md    focus:outline-none focus:bg-[#DAF4A8] focus:border-black focus:ring-opacity-40"
                required
                placeholder="Full Name"
              />
              
               <p className="text-xs leading-3"> <small>Your full name will not be publicly visible </small> </p>
              
            </div>
            <div className="mb-2">
              <input
                type="text"
                className="block w-full px-4 py-2 peer  text-black  bg-white border rounded-md focus:bg-[#DAF4A8]   focus:outline-none  focus:border-black focus:ring-opacity-40"
                placeholder="Username"
                required
              />
              <p className="text-xs leading-3 mb-2"><small>
            ...
            <div class="flex items-start items-center mb-4">
              <input
                ...
                type="checkbox"
                class="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-blue-300 h-3 w-3 rounded"
              />
              <label
                for="checkbox-3"
                className="text-xs ml-3  leading-3 font-small text-gray-900"
              >
               <p><small>I’d like to receive personalised offers and be the first to
                receive updates about latest Dashme Africa.</small></p> 
              </label>
            </div>
            ...
            <input
                ...
                aria-describedby="checkbox-3"
                type="checkbox"
                className="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-blue-300  h-5 w-4 rounded"
              />
              <label
                for="checkbox-3"
                className=" ml-3 font-small text-gray-900"
              >
                <p className="text-xs leading-3"><small>By registering, I confirm that I accept Dashme Africa’s <span className="text-[#DAF4A8]  ">Terms
                and Conditions,</span> and I have read the <span className="text-[#DAF4A8] "> Privacy Policy,</span> and that I’m
                at least 18 years old.</small></p>
              </label>
            </div>
        ...
        <div className="w-1/2 h-86 mb-12 rounded-md p-6 mr-8 bg-black">
          {/* Image */}
          <img
            src={frame}
            alt="Signup Image"
            className="w-full mt-44 mb-40  object-cover "
          />
        </div>
      </div>
    </div>
